...
def _temp_line_fig() -> go.Figure:
    ...
    fig.update_layout(
        ...
        margin=dict(l=54, r=20, t=46, b=72), height=320,
        hovermode="x unified",
        # Legenda spostata SOTTO il grafico (prima si sovrapponeva al titolo).
        legend=dict(orientation="h", yanchor="top", y=-0.26, xanchor="center", x=0.5,
    ...
    fig.add_annotation(xref="paper", yref="paper", x=0, y=1, xshift=-34, yshift=10,
